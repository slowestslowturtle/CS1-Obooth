...
double dividenums(double &, double &);
...
int main()
{
    ...
    cout << '\n';
    printf("The product of the two numbers is: %f", multiplynums(num1, num2));
    cout << '\n';
    printf("the quotient of the first divided by the second is: %f", dividenums(num1, num2));
    cout << '\n';
...
// Run all functions and make them return the proper values
...
//Test the functions to make sure they return the proper values
void test()
{
